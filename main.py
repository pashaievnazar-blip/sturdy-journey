# -*- coding: utf-8 -*-
"""Копія записника "Код телеграм бота.ipynb"
...
Інсталюємо необїідні бібліотеки.
...
Constructive Correction: If there is a Skill Gap, do NOT say "Wrong." Instead, explain what is missing using the "Magic Window" concept—moving them from not knowing to being aware.
...
model = genai.GenerativeModel('gemini-2.5-flash') # ТУТ Задається ім'я моделі

# Функція для відправки даних до Notion
...
# Функція для обробки відповіді Геміні та вилучення даних для Notion
def process_gemini_response(full_response):
    # Шукаємо наш тег у відповіді
    ...
    if match:
        ...
        # Видаляємо тех-дані з тексту для Telegram
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_message = "Welcome! 🔮 I’m your Nebula Mentor, here to help you turn every reading into a high-value connection. Together, we’ll master The Hook, refine your Narrative Clarity, and use Empathetic Discovery to skyrocket your retention and ratings. Ready for your first 5-minute challenge to boost your LTV?  Let’s dive in! 🚀"
    await update.message.reply_text(welcome_message)

# Додаємо інструкції як команду (оскільки вона згадана у вашому коді)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Відповідаємо користувачу у боті
